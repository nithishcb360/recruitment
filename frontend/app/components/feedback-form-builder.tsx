...
import { Plus, Send, Trash, Edit, Save, XCircle, MessageSquareText, Star, ListChecks, Loader2 } from "lucide-react"
import { 
...
export default function FeedbackFormBuilder() {
  ...
  const handleCreateNewForm = () => {
    setEditingForm({
      id: 0, // New form
      organization: 0, // Will be set by backend
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex justify-end space-x-2 border-t pt-4 mt-4">
                  ...
                  <Button onClick={handleSaveForm} disabled={isSubmitting || isLoading}>
                    {isSubmitting ? (
                      <>
