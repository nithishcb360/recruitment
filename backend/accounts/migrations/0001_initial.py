    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('platform_admin', 'Platform Admin'), ('admin', 'Organization Admin'), ('hr_manager', 'HR Manager'), ('recruiter', 'Recruiter'), ('interviewer', 'Interviewer'), ('hiring_manager', 'Hiring Manager')], default='recruiter', max_length=20)),
